      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          <AccordionItem value="item-1" className="border rounded-lg px-6">
            <AccordionTrigger className="text-lg font-semibold">How secure is my journal data?</AccordionTrigger>
          ...
          <AccordionItem value="item-2" className="border rounded-lg px-6">
            <AccordionTrigger className="text-lg font-semibold">What makes Psykick different from other journaling apps?</AccordionTrigger>
            <AccordionContent className="text-gray-600">
          ...
          <AccordionItem value="item-3" className="border rounded-lg px-6">
            <AccordionTrigger className="text-lg font-semibold">Can I use Psykick offline?</AccordionTrigger>
            <AccordionContent className="text-gray-600">
          ...
          <AccordionItem value="item-4" className="border rounded-lg px-6">
            <AccordionTrigger className="text-lg font-semibold">What types of media can I add to my journal?</AccordionTrigger>
            <AccordionContent className="text-gray-600">
