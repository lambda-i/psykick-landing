            ...
            <div className="w-full md:w-1/2">
              <div className="relative max-w-[250px] mx-auto">
                <div className="relative border-8 border-black rounded-[3rem] overflow-hidden aspect-[9/19] shadow-xl">
                  ...
                  <img src="/lovable-uploads/Landing main.png" alt="Camera Screen" className="w-full h-full" />
                </div>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2">
              <div className="relative max-w-[250px] mx-auto">
                <div className="relative border-8 border-black rounded-[3rem] overflow-hidden aspect-[9/19] shadow-xl">
                  {/* Camera Screen */}
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-7 bg-black rounded-b-2xl"></div>
                  <img src="/lovable-uploads/MoodJournalEntry.png" alt="Camera Screen" className="w-full h-full" />
                </div>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2">
              <div className="relative max-w-[250px] mx-auto">
                <div className="relative border-8 border-black rounded-[3rem] overflow-hidden aspect-[9/19] shadow-xl">
                  {/* Camera Screen */}
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-7 bg-black rounded-b-2xl"></div>
                  <img src="/lovable-uploads/Insights Page.png" alt="Camera Screen" className="w-full h-full" />
                </div>
              </div>
            </div>
            <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <div className="w-full md:w-1/2">
              <div className="relative max-w-[250px] mx-auto">
                <div className="relative border-8 border-black rounded-[3rem] overflow-hidden aspect-[9/19] shadow-xl">
                  {/* Camera Screen */}
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-7 bg-black rounded-b-2xl"></div>
                  <img src="/lovable-uploads/History.png" alt="Camera Screen" className="w-full h-full" />
                </div>
              </div>
            </div>
            <div className="w-full md:w-1/2 text-center md:text-right">
